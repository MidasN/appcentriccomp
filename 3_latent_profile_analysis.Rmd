...
colnames_lpa = colnames(d)[!(colnames(d) %in% c("RecordNo",
                                                "Q17",
                                                "Occupation",
                                                "profile_education",
...
TODO: exclude binary variables from LPA

Best on the BIC, we should choose EEE = Constrained variance, constrained covariance model = model 2
